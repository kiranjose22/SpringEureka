...
public interface ResultsRepository extends CrudRepository<Results, String> {
    ...
    @Query(value="select users.user_name,trainer_details.experience from users,trainer_details,users_skills where trainer_details.email=users.email and users_skills.users_email=users.email and " +
